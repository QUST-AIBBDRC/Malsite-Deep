...
yscore_sum.to_csv('yscore_sum_SVM_Near_Miss_train_fusion.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_SVM_Near_Miss_train_fusion.csv')
...
data_csv.to_csv('SVM_Near_Miss_train_fusion.csv')
